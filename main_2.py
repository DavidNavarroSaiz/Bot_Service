...
vectordb = Chroma.from_documents(documents, embedding=OpenAIEmbeddings(), persist_directory="./docs/data")
vectordb.persist()
    ...
    if query:
        ...
        if prob.item() > 0.998:
            ...
            with get_openai_callback() as cost:
                ...
                # with get_openai_callback() as cost:
                response = pdf_qa({"question": query, "chat_history": chat_history})
